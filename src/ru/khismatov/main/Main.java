    ...
    while (task_num != 8) {
      switch (task_num) {
        ...
        case 3:
          ...
          System.out.println(
              "The number of people Ilya told the secret to: " + secret3.get_count_next_guards());
          System.out.println(
              "The previous guard of Ilya secret's: " + secret3.get_guard_by_order(-1));
          System.out.println("The next guard of Ilya secret's: " + secret3.get_guard_by_order(1));
          System.out.println(
              "Difference in length of secret between Ilya and Polina: "
                  + secret2.get_delta_length(-1));
          System.out.println(
              "Difference in length of secret between Ilya and Cirk: "
                  + secret2.get_delta_length(1));
          try {
        ...
        case 5:
          ...
          if (frac1.equals(frac2)) {
            System.out.println("Fraction equals: " + frac1);
          } else {
            System.out.println("Fraction not equals: " + frac1 + " != " + frac2);
          }
          break;
        case 6:
          calc = new Calculator();
        ...
        case 7:
          ...
          System.out.println(
              "Fractions is same objects: " + (original.getClass() == cloned.getClass()));
          break;
      }
      System.out.println("Enter the number of task(8 is exit): ");
